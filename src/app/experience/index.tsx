    ...
    return(
        <CustomContainer className='expe' topMargin='10' bottomMargin='4'>
            <FlexRow justifyContent="flex-start" gap="2">
                    <AppText color="rgb(228, 146, 245)" textSize="4" fontWeight="400" className="expe-heading"><AppSpan color="rgb(240, 196, 248)" textSize="3" fontWeight="500" rightMargin="1" className="about-expe">02.</AppSpan>Where i've worked</AppText>
